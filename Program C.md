...
/*!< Specifies the speed for the selected pins. 
     This parameter can be a value of @ref GPIospeed_rypeDef */
GPTOSpeed_TypeDef GPIo_speed;
...
在程序中，GPIO_InitTypeDef是对结构体变量的重命名，GPIO_InitStructure是对应结构体的名字，在定义结构体的时候就是结构体名字.具体结构体变量名字
...
# 9 volatile
`volatile`表示：**该对象的值可能在当前代码无法直接观察到的地方发生变化，编译器不能假设它保持不变**。
