...
圆角矩形（开始/结束）：用圆括号 A(文字)
  
菱形框（条件判断）：用尖括号/菱形括号 A{文字}
...
x=a+by=c+dz=x+y\begin{aligned} x &= a+b \\ y &= c+d \\ z &= x+y \end{aligned}
